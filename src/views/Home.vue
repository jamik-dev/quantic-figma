    ...
    <main class="flex items-center">
      <div class="w-1/2">
        <div class="flex flex-col space-y-8">
          ...
          <p class="text-primary font-outfit tracking-thin max-w-[75%]">21-oktabr, O'zbek tiliga davlat tili maqomi
            berilganligining 31 yillik munosabati bilan o'zbekcha matnni nutqga o'girish texnologiyasini ishlab chiqdik
          </p>
          <div class="flex space-x-8">
            <div class="flex flex-col space-y-3 items-center">
              <p class="flex text-primary font-outfit items-center"><img class="mr-5" src="../assets/img/microphone.svg"
                  alt="">Tabiiy ovozda</p>
              <p class="flex text-primary font-outfit items-center"><img class="mr-4 -ml-4" src="../assets/img/time.svg"
                  alt="">Yuqori tezlik</p>
            </div>
            <div class="flex flex-col space-y-4">
              <p class="flex text-primary font-outfit items-center"><img class="mr-5" src="../assets/img/ai.svg"
                  alt="">To'liq sun'iy intelekt asosida</p>
              <p class="flex text-primary font-outfit items-center"><img class="mr-5" src="../assets/img/voice.svg"
                  alt="">2ta ovozda tinglash imkoniyati</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full flex mt-20">
      ...
      <div class="w-1/2">
        <div class="flex mt-24 justify-center">
          <p class="max-w-[80%] font-outfit tracking-wide text-primary text-[18px] font-thin">Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Expedita iusto rem culpa? Quod nostrum illo sint iste autem est aliquam
            quisquam.</p>
        </div>
    ...
    <div class="w-full mt-40 mb-60">
      ...
      <div class="flex mt-20 justify-between relative">
        ...
        <div class="flex flex-col -translate-x-20 w-1/3 items-center">
          <div class="h-24 w-24 flex items-center shadow-xl justify-center bg-white rounded-[100%]"><img
        ...
        <div class="flex flex-col translate-y-40 w-1/3 items-center">
          <div class="h-24 w-24 flex items-center shadow-xl justify-center bg-white rounded-[100%]"><img
              src="../assets/img/money-bag.svg" alt=""></div>
          <div class="mt-6 space-y-3">
        ...
        <div class="flex flex-col translate-x-20 w-1/3 items-center">
          <div class="h-24 w-24 flex items-center shadow-xl justify-center bg-white rounded-[100%]"><img
              src="../assets/img/rocket.svg" alt=""></div>
          <div class="mt-6 space-y-3">
      ...
      <div class="flex rounded-xl w-full p-2 bg-greyish">
        ...
        <div class="w-2/3">
          <div class="w-full p-8 h-1/2 flex items-center justify-center">
            ...
            <div class="w-1/3 flex space-x-2 items-center">
              <img src="../assets/img/marketing-icon.svg" class="hover:-translate-y-2 duration-300 cursor-pointer"
                alt="">
          ...
          <div class="w-full p-8 h-1/2 flex items-center justify-center">
            <div class="w-1/3 flex space-x-2 items-center">
              <img src="../assets/img/scholarship-icon.svg" class="hover:-translate-y-2 duration-300 cursor-pointer"
                alt="">
              <p class="font-outfit text-md text-primary tracking-wide">Ta'lim & <br> Sohalari</p>
            </div>
            <div class="w-1/3 flex space-x-2 items-center">
              <img src="../assets/img/smartphone-icon.svg" class="hover:-translate-y-2 duration-300 cursor-pointer"
                alt="">
              <p class="font-outfit text-md text-primary tracking-wide">Online & <br> Dasturlar</p>
            </div>
            <div class="w-1/3 flex space-x-2 items-center">
              <img src="../assets/img/languages-icon.svg" class="hover:-translate-y-2 duration-300 cursor-pointer"
                alt="">
