  ...
  <div class="w-full py-4 z-10 sticky -top-1 lg:top-0 bg-white">
    ...
    <div class="w-[90%] lg:w-[85%] xl:w-[80%] mx-auto">
      <div class="flex justify-between items-center">
        ...
        <div @click="burgerToggle = !burgerToggle"
          class="lg:hidden flex justify-center items-center h-12 w-12 bg-red-100 rounded-[100%] z-20"><img :src="imgUrl"
            :class="{ 'w-[45%]': burgerToggle }" alt="">
        </div>
      </div>
    </div>
    ...
    <transition name="fade">
      ...
      <div v-if="burgerToggle" class="w-full h-full fixed lg:hidden bg-white">
        <div class="w-[90%] md:flex flex-row-reverse justify-between mx-auto mt-10">
          ...
          <div class="flex mt-10 md:mt-5 ml-2">
